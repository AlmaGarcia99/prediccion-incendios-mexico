...
col1.metric("Incendios", "71,000+")
col2.metric("Categorías", "6")
col3.metric("Estados", "32")
col4.metric("Modelo IA", "Random Forest")

st.caption("Modelo balanceado con precisión aproximada del 54% usando Random Forest.")
